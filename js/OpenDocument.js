...
mindmaps.OpenDocumentView = function() {
  ...
  var $table_database = $dialog.find(".database-filelist");
  $table_database.delegate("a.title", "click", function() {
    if (self.documentDatabaseClicked) {
      var t = $(this).tmplItem();
      console.log('t', t)
      self.documentDatabaseClicked(t.data);
    }
  }).delegate("a.delete", "click", function() {
    if (self.deleteDocumentDatabaseClicked) {
      var t = $(this).tmplItem();
      self.deleteDocumentDatabase(t.data);
    }
  });
...
mindmaps.OpenDocumentPresenter = function(eventBus, mindmapModel, view, filePicker) {
  ...
  */
  ...
  view.documentDatabaseClicked = function(doc) {
  ...
  */
  this.go = function() {
    var docs = mindmaps.LocalDocumentStorage.getDocuments();
    mindmaps.LocalDocumentStorage.getDocumentsFromDatabase(function(err, docs) {
